...
@WebServlet("/get_ongoing_schedule.do")
public class GetOngoingAllScheduleServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            final String CACHE_ATTRIBUTE = "ongoing_schedule_list" + journeyDate.toString();

            if(session.getAttribute(CACHE_ATTRIBUTE) == null) {
                ArrayList<Schedule> list = Schedule.collectAllScheduleRecords(journeyDate, operator.getOperatorId(), 12);
