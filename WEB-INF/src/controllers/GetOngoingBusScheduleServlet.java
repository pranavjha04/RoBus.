...
@WebServlet("/get_ongoing_bus_schedule.do")
public class GetOngoingBusScheduleServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            final String CACHE_ATTRIBUTE = "ongoing" + busId + "schedule_list" + journeyDate.toString();

            if(session.getAttribute(CACHE_ATTRIBUTE) == null) {
                ArrayList<Schedule> list = Schedule.collectBusScheduleRecords(journeyDate, busId, operator.getOperatorId(), 12);
