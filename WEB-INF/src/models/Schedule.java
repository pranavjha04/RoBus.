...
public class Schedule {
    ...
    public static boolean updateDriver(int driverId, int busId, int scheduleId, int operatorId) {
        ...
        try {
            ...
            String query = 
                        ...
                        "JOIN operators opr ON b.operator_id = opr.operator_id " +
                        "SET driver_id=? " +
                        "WHERE sch.schedule_id=? AND b.bus_id=? AND opr.operator_id=?";
    ...
    public static Schedule getRecord(int scheduleId, int operatorId) {
        ...
        try {
            ...
            String query = 
                        ...
                        "WHERE opr.operator_id=? AND sch.schedule_id=?";
    ...
    public static Schedule getRecordByStatus(int scheduleId, int statusId) {
        Schedule schedule = null;
        try {
            Connection con = DBManager.getConnection();
            String query = 
                        ...
                        "JOIN states ds ON d.state_id = ds.state_id " +
                        "JOIN status st ON st.status_id = opr.status_id " +
                        "WHERE schs.status_id=? AND sch.schedule_id=?";
    ...
    public static ArrayList<Schedule> collectAllScheduleRecords(Date journeyDate, int operatorId, int statusId) {
        ArrayList<Schedule> list = new ArrayList<>();
        ...
        try {
            ...
            String query = 
                        ...
                        "JOIN states ds ON d.state_id = ds.state_id " +
                        "JOIN status st ON st.status_id = opr.status_id " +
                        "WHERE opr.operator_id=? AND sch.journey_date=? AND sch.status_id=?";
    ...
    public static ArrayList<Schedule> collectAllScheduleRecords(Date journeyDate, int operatorId) {
        ArrayList<Schedule> list = new ArrayList<>();
        ...
        try {
            ...
            String query = 
                        ...
                        "JOIN states ds ON d.state_id = ds.state_id " +
                        "JOIN status st ON st.status_id = opr.status_id " +
                        "WHERE opr.operator_id=? AND sch.journey_date=?";
    ...
    public static ArrayList<Schedule> collectBusScheduleRecords(Date journeyDate, int busId, int operatorId, int statusId) {
        ArrayList<Schedule> list = new ArrayList<>();
        ...
        try {
            ...
            String query = 
                        ...
                        "JOIN states ds ON d.state_id = ds.state_id " +
                        "JOIN status st ON st.status_id = opr.status_id " +
                        "WHERE opr.operator_id=? AND sch.journey_date=? AND b.bus_id=? AND sch.status_id=?";
    ...
    public static ArrayList<Schedule> collectSearchedScheduleRecord(Integer requestedSource, Integer requestedDestination, Date requestedJourneyDate) {
        ArrayList<Schedule> list = new ArrayList<>();
        ...
        try{
            ...
            String query = 
                        ...
                        "JOIN states ds ON d.state_id = ds.state_id " +
                        "JOIN status st ON st.status_id = opr.status_id " +
                        "WHERE r.source=? AND r.destination=? AND sch.journey_date=? AND sch.status_id=11";
            
            PreparedStatement ps = con.prepareStatement(query);

            ps.setInt(1, requestedSource);
            ps.setInt(2, requestedDestination);
            ps.setDate(3, requestedJourneyDate);
            ...
            while(rs.next()) {
                ...
                Operator operator = new Operator(
                    rs.getInt("o.operator_id"),
                    rs.getString("o.full_name"),
                    rs.getString("o.address"),
                    rs.getString("o.email"),
                    rs.getString("o.password"),
                    rs.getString("o.contact"),
                    rs.getString("o.certificate"),
                    rs.getString("o.website"),
                    rs.getString("o.logo"),
                    rs.getString("o.banner"),
                    rs.getString("o.verification_code"),
                    rs.getInt("o.base_charge"),
                    new Status(rs.getInt("os.status_id"), rs.getString("os.name")),
                    rs.getTimestamp("o.created_at"),
                    rs.getTimestamp("o.updated_at"),
                    user
                );
