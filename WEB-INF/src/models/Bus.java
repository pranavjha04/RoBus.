...
public class Bus implements Cloneable {
    ...
    public void setBusImageList(ArrayList<BusImage> busImageList) {
        this.busImageList = busImageList;
    }
    
    public ArrayList<BusImage> getBusImageList() {
        return this.busImageList;
    }
