...
public class Driver {
    ...
    public static ArrayList<Driver> collectDriverStatus(Integer operatorId, Integer statusId) {
        ...
        try {
            ...
            String query = 
                            ...
                            "JOIN status s ON u.status_id = s.status_id " +
                            "JOIN user_types ut ON u.user_type_id = ut.user_type_id " +
                            "WHERE operator_id=? AND s.status_id=?";
            PreparedStatement ps = con.prepareStatement(query);
    ...
    public static ArrayList<Driver> collectActiveDrivers(Integer operatorId) {
        return collectDriverStatus(operatorId, 4);
    }

    public static ArrayList<Driver> collectInactiveDrivers(Integer operatorId) {
        return collectDriverStatus(operatorId, 5);
    }
