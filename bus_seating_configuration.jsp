...
<html lang="en">
  <head>
    ...
    <title>Bus Seating Configuration | RoBus</title>
    <style>
      .bus {
        display: grid;
  ...
  <body>
    ...
    <div class="dashContainer">
      ...
      <main class="content-wrapper bg-light">
        <aside
          class="border bg-white p-3 d-flex flex-column gap-5 side-bar gap-4 h-100"
          style="overflow: auto"
        >
          <span
        ...
        <!-- Dashboard Content -->
        <div
          class="p-4 d-flex flex-column gap-3 align-items-center"
          id="pageWrapper"
        >
